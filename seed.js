...
var db_1 = require("./src/app/api/db");
...
function seedDatabase() {
    return __awaiter(this, void 0, void 0, function () {
        var db, _i, seedUsers_1, user, hashedPassword;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    _a.label = 2;
                case 2:
                    if (!(_i < seedUsers_1.length)) return [3 /*break*/, 6];
                    user = seedUsers_1[_i];
                    return [4 /*yield*/, bcryptjs_1.default.hash(user.password, 10)];
                case 3:
                    hashedPassword = _a.sent();
                    return [4 /*yield*/, db.collection('wydexadmin').insertOne({
